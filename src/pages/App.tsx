...
import SimulationDiagram from '../components/SimulationDiagram.tsx';
import {performCalculations} from '../utils/calculations.ts';
import {SimulationType, SimulationData, SimulationResult} from '../types.ts';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-indigo-950 to-gray-900">
            <div className="relative">
                {/* Efectos de fondo */}
                <div
                    className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-400/20 via-transparent to-transparent blur-3xl"/>
                <div
                    className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-400/20 via-transparent to-transparent blur-3xl"/>
